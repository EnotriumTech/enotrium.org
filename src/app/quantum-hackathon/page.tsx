          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-[#0d1b3e] border border-white/20 text-white font-semibold px-6 py-3 rounded hover:bg-[#0d1b3e]/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
